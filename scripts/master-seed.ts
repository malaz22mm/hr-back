...
async function main() {
    ...
    const employeesPath = path.resolve(__dirname, './Employees_Dataset_With_Synthetic_Health.csv');
...
async function seedLookups() {
    ...
    await prisma.healthState.createMany({
        data: [
            ...
            { id: 1, name: 'Minor Chronic Condition', name_code: 'minor_chronic_condition' },
            { id: 2, name: 'Moderate Health Issues', name_code: 'moderate_health_issues' },
            { id: 3, name: 'Serious Health Issues', name_code: 'serious_health_issues' },
        ],
        skipDuplicates: true,
    });
