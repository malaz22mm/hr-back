...
CREATE TABLE "Employees" (
    ...
    "health_state_id" INTEGER NOT NULL,
...
CREATE TABLE "HealthState" (
    ...
    CONSTRAINT "HealthState_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "Employees" ADD CONSTRAINT "Employees_health_state_id_fkey" FOREIGN KEY ("health_state_id") REFERENCES "HealthState"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
